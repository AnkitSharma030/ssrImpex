...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Head>
        <title>SSSR Overseas - Your Trusted Partner in Shipping &amp; Logistics</title>
        <meta name="description" content="Efficient, reliable, and cost-effective shipping and logistics solutions" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      {/* Navigation */}
      <nav className="bg-gradient-to-r from-zinc-900 to-zinc-600 text-white p-4">
        <div className="container mx-auto flex justify-between items-center">
          <div className="text-2xl font-bold">SSSR Overseas</div>
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <div className="md:hidden mt-4 bg-gradient-to-r from-zinc-600 to-zinc-400 p-4 rounded">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-zinc-900 to-zinc-600 text-white py-20">
      ...
      <section id="about" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-zinc-900">About Us</h2>
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <div className="bg-blue-100 h-64 w-full rounded-lg flex items-center justify-center">
                <svg className="w-32 h-32 text-zinc-900" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
              </div>
            </div>
            <div className="md:w-1/2 md:pl-12">
              <h3 className="text-2xl font-semibold mb-4 text-zinc-900">Our Story</h3>
              <p className="text-gray-700 mb-4">
                SSSR Overseas has been a leader in the shipping and logistics industry for over 15 years. 
      ...
      <section id="services" className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-zinc-900 cursor-pointer" onClick={()=> router.push('/services')}>Our Services</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 " >
              ...
              <h3 className="text-xl font-semibold mb-3 text-zinc-900">Freight Shipping</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
              ...
              <h3 className="text-xl font-semibold mb-3 text-zinc-900">Warehousing</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
              ...
              <h3 className="text-xl font-semibold mb-3 text-zinc-900">Supply Chain Management</h3>
              <p className="text-gray-700">
