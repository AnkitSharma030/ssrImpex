          ...
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/2 mb-8 md:mb-0">
              ...
              <div className="mb-4 flex items-center">
                ...
                <span>123 Shipping Avenue, Logistics City, 10001</span>
              </div>
              <div className="mb-4 flex items-center">
                <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="md:w-1/2 md:pl-12">
              <form className="space-y-4">
                <div>
                  ...
                  <input type="text" id="name" className="w-full p-2 rounded text-gray-800" />
                </div>
                <div>
                  <label htmlFor="email" className="block mb-1">Email</label>
                  <input type="email" id="email" className="w-full p-2 rounded text-gray-800" />
                </div>
                <div>
                  <label htmlFor="message" className="block mb-1">Message</label>
                  <textarea id="message" rows="4" className="w-full p-2 rounded text-gray-800"></textarea>
                </div>
